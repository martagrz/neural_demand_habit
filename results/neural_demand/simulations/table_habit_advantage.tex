...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcccc}
    ...
    Neural Demand (habit) & $0.00852 \pm 0.00026$ & $0.00033 \pm 0.00002$ & 81.5\% & {---} \\
  ...
  \begin{tablenotes}\small
    \item True DGP: \texttt{HabitFormationConsumer} with    $\delta_{true}=0.7$.    $\hat{\delta} = 0.653 \pm    0.017$ (mean $\pm$ SE over 5 runs).    True $\delta$ in identified set: 100\% of seeds.
  \end{tablenotes}
  \end{threeparttable}
\end{table}
